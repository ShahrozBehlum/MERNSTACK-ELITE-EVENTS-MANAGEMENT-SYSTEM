    ...
    const handleBooking = async () => {
        ...
        try {
            if (!showOTP) {
                ...
                toast.success("Booking requested! Awaiting admin confirmation.")
                setShowOTP(false);
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-center gap-4 text-gray-600">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold text-gray-800 text-lg">{event.ticketPrice === 0 ? <span className="text-green-500">Free</span> : `${event.ticketPrice} PKR`}</p>
                                </div>
                            </div>
