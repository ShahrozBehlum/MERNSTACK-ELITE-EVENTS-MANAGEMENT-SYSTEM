...
const AdminDashboard = () => {
    ...
    const handleCreateEvent = async (e) => {
        ...
        try {
            ...
            await api.post("/events", data); // ✅ send FormData ONLY
    ...
    const handleUpdateEvent = async (e) => {
        ...
        try {
            const response = await api.put(`/events/${selectedEvent._id}`, {
                ...
                eventImage: formData.eventImage, // if backend supports URL/string
            });
            ...
            {update && selectedEvent && (
                <div className='"bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown'>
                    ...
                    <form onSubmit={handleUpdateEvent} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <input name='title' type="text" value={formData.title} className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, title: e.target.value })
                        } />
                        <input type="text" value={formData.category} className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, category: e.target.value })
                        } />
                        <input type="date" value={formData.date} className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, date: e.target.value })
                        } />
                        <input type="text" value={formData.location} className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, location: e.target.value })
                        } />
                        <input type="text" value={formData.totalSeats} className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, totalSeats: e.target.value })
                        } />
                        <input type="text" value={formData.ticketPrice} className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, ticketPrice: e.target.value })
                        } />
                        <textarea name="" value={formData.description} className="border px-4 py-3 rounded-lg md:col-span-2 h-32 focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={(e) =>
                            setFormData({ ...formData, description: e.target.value })
                        }></textarea>
                        <button
                            type="submit" className="md:col-span-2 bg-gray-900 text-white font-bold py-3 mt-2 rounded-lg hover:bg-black transition shadow-md">Save
                        </button>
                    </form>
                </div>
            )}
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown">
                    ...
                    <form onSubmit={handleCreateEvent} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <input type="file" placeholder="Upload Event Image"
                                name="eventImage" className="w-full border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" onChange={e => setFormData({ ...formData, eventImage: e.target.files[0] })} />
                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3 w-full sm:w-auto">
                                            <button
                                                ...
                                                className="flex-1 sm:flex-none text-green-500 hover:text-white hover:bg-green-500 border border-green-200 px-4 py-2 rounded-lg text-sm font-bold transition shadow-sm"
                                            >
                                                Edit
                                            </button>
